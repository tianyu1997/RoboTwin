...
class explore_4cabinets(Base_Task):
    ...
    def load_actors(self):
        ...
        self.opposite_cabinet = self.cabinets[3]
    ...
    def play_once(self):
        ...
        self.move(self.grasp_actor(self.cabinet, arm_tag=arm_tag,pre_grasp_dis=0.05),  self.grasp_actor(self.opposite_cabinet, arm_tag=arm_tag.opposite,pre_grasp_dis=0.05))
        ...
        for _ in range(4):
            ...
            self.move(self.move_by_displacement(arm_tag=arm_tag.opposite , y=-0.05))
